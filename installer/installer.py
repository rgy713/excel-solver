...
def main():
    ...
    sub = Popen(["pyinstaller", "--clean", "setting.spec"], env=env)
    sub.communicate()
    ...
    cefapp_dir = os.path.join(curdir, "dist", "LPSolverService")
    executable = os.path.join(cefapp_dir, "LPSolverService"+EXE_EXT)
